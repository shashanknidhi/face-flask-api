...
client = pymongo.MongoClient("mongodb+srv://shashank:qm3nD9fESfVPHaWS@cluster0.aqrnmkp.mongodb.net/?retryWrites=true&w=majority")
users_collection = client.jaipurhackathon.users
